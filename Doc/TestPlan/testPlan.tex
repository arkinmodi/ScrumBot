...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccccccccc}
        % ~ & \textbf{FRT-BE1} & \textbf{FRT-BE2} & \textbf{FRT-BE3} & \textbf{FRT-BE4} & \textbf{FRT-BE5} & \textbf{FRT-BE6} & \textbf{FRT-BE7} & \textbf{FRT-BE8-1} & \textbf{FRT-BE8-2} & \textbf{FRT-BE9-1} & \textbf{FRT-BE9-2} & \textbf{FRT-BE10-1} & \textbf{FRT-BE10-2} & \textbf{FRT-BE11}\\
...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccccccccccccccc}
        % ~ & \textbf{NFRT-UH13-1} & \textbf{NFRT-UH13-2} & \textbf{NFRT-UH13-3} & \textbf{NFRT-UH4} & \textbf{NFRT-P1} & \textbf{NFRT-P2} & \textbf{NFRT-P3} & \textbf{NFRT-OE1} & \textbf{NFRT-OE2} & \textbf{NFRT-OE3} & \textbf{NFRT-OE4} & \textbf{NFRT-OE5} & \textbf{NFRT-OE6} & \textbf{NFRT-OE7} & \textbf{NFRT-MS1} & \textbf{NFRT-MS2} & \textbf{NFRT-MS3} & \textbf{NFRT-MS4-1} & \textbf{NFRT-MS4-2} & \textbf{NFRT-S1}\\
