...
\begin{tabular}{|l|l|l|l|}
    ...
    \textbf{Routine Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
    \hline
    new Meeting & String, \textcolor{red}{\sout{Date, Time} String}, MeetingT & Meeting & \\
    \hline
    new Meeting & String, \textcolor{red}{\sout{Date, Time} String}, MeetingT, String & Meeting & \\
    \hline
    get\_name & & String &\\
    \hline
    \textcolor{red}{get\_datetime} & & \textcolor{red}{String} &\\
    \hline
    \textcolor{red}{\sout{get\_date}} & & \textcolor{red}{\sout{Date}}&\\
    \hline
    \textcolor{red}{\sout{get\_time}} & & \textcolor{red}{\sout{Time}}&\\
    \hline
    get\_type & & MeetingT &\\
    \hline
    get\_desc & & String &\\
...
\subsubsection* {State Variables}
$name$: String\\
\textcolor{red}{\sout{$date$: Date}}\\
\textcolor{red}{\sout{$time$: Time}}\\
...
\subsubsection* {Access Routine Semantics}
\noindent new Meeting($n$, \textcolor{red}{\sout{$d$, $t$} $dt$}, $type$)
\begin{itemize}
    \item transition: $name,$ \textcolor{red}{\sout{$time,\ date$}$,\ d$},\ $type,\ desc := n,$ \textcolor{red}{\sout{$d,\ t$} $Datetime(dt),$}\ $type,\ \text{None}$
    \item output: $out :=$ self
\end{itemize}

\noindent new Meeting($n$, \textcolor{red}{\sout{$d$, $t$} $dt$}, $type$, $desc$)
\begin{itemize}
    \item transition: $name,$ \textcolor{red}{\sout{$time,\ date$}$,\ d$},\ $type,\ desc := n,$ \textcolor{red}{\sout{$d,\ t$} $Datetime(dt),$}\ $type,\ desc$
    \item output: $out :=$ self
\end{itemize}

\noindent \textcolor{red}{\sout{get\_name()}}
\begin{itemize}
    \item \textcolor{red}{\sout{$output: out := name$}}
\end{itemize}

\noindent \textcolor{red}{\sout{get\_date()}}
\begin{itemize}
    \item \textcolor{red}{\sout{$output: out := date$}}
\end{itemize}

\noindent \textcolor{red}{\sout{get\_time()}}
\begin{itemize}
    \item \textcolor{red}{\sout{$output: out := time$}}
\end{itemize}
...
\noindent get\_desc()
\begin{itemize}
    \item output: $out :=$ \textcolor{red}{\sout{desc}$ (desc = \text{None} \Rightarrow ``\text{No description}"\ |\ desc)$}
\end{itemize}
...
\begin{tabular}{|l|l|l|l|}
    ...
    \textbf{Routine Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
    \hline
    new Task & String, \textcolor{red}{\sout{Date, Time} String} & Task & \\
    \hline
    new Task & String, \textcolor{red}{\sout{Date, Time} String}, Details & Task & \\
    \hline
    \textcolor{red}{get\_name} & & \textcolor{red}{String} & \\
    \hline
    get\_deadline & & \textcolor{red}{\sout{(Date, Time)} String} & \\
    \hline
    get\_details & & String & \\
    \hline
...
\subsubsection*{State Variables}
$name$: String\\
$deadline$: \textcolor{red}{\sout{(Date, Time)} Datetime}\\
$details$: String\\
...
\subsubsection*{Access Routine Semantics}
\noindent new Task($s,$ \textcolor{red}{\sout{$d, t$} $dt$})
\begin{itemize}
    \item transition: $name, deadline, details := s,$ \textcolor{red}{\sout{$(d, t)$} $Datetime(dt)$}$, \text{None}$
    \item output: $out :=$ self
\end{itemize}

\noindent new Task($s,$ \textcolor{red}{\sout{$d, t$} $dt$}$, details$)
\begin{itemize}
    \item transition: $name, deadline, details := s,$ \textcolor{red}{\sout{$(d, t)$} $Datetime(dt)$}$, details$
    \item output: $out :=$ self
\end{itemize}
...
\begin{itemize}
    \item output: $out :=$ \textcolor{red}{\sout{$deadline$}$Datetime(deadline)$}
\end{itemize}
