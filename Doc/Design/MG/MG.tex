...
\begin{description}
    \item [\refstepcounter{mnum} \mthemnum \label{m1}:] ScrumBot Module
    \item [\refstepcounter{mnum} \mthemnum \label{m2}:] Meeting Types Module
    \item [\refstepcounter{mnum} \mthemnum \label{m3}:] Meeting List Module
    \item [\refstepcounter{mnum} \mthemnum \label{m4}:] Meeting Module
    % \item [\refstepcounter{mnum} \mthemnum \label{m4}:] Task Module
    % \item [\refstepcounter{mnum} \mthemnum \label{m5}:] Task List Module
    % \item [\refstepcounter{mnum} \mthemnum \label{m6}:] Project Module
    % \item [\refstepcounter{mnum} \mthemnum \label{m7}:] Project List Module
\end{description}
...
& ScrumBot Module \textcolor{red}{(POSSIBLY SOFTWARE DECISION MODULE)}\\
& Meeting Module\\
\midrule
...
\subsubsection{Meeting Module (\mref{m2})}
